...
const en = {
  ...
  startOverConfirm:
    "Submit the current draft as a result and start a new dictation?",
  editSong: "Edit song",
  ...
  sourceUpdatedWarning:
    "Saving lyric changes will submit any in-progress draft as a result.",
...
const zh: Messages = {
  ...
  startOver: "重新默写",
  startOverConfirm: "当前内容会提交为一次默写结果。确定重新开始吗？",
  editSong: "编辑歌词",
  deleteSong: "删除这首歌",
  deleteSongConfirm: "确定删除这首歌和所有默写记录吗？删除后无法恢复。",
  delete: "删除",
  sourceUpdatedWarning: "保存修改后，当前内容会自动提交为一次默写结果。",
  lyricsHeading: "歌词",
